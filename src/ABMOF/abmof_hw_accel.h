...
#define POLARITY_Y_ADDR_MASK (1023 << POLARITY_Y_ADDR_SHIFT) // 9 bits from bits 22 to 30
...
#define SLICE_WIDTH  1024
#define SLICE_HEIGHT 512				//Default = 512

#define DVS_WIDTH  640					//Default = 346
#define DVS_HEIGHT 400					//Default = 260

#define BITS_PER_PIXEL 4
#define COMBINED_PIXELS 32

// ABMOF parameters, hardcoded:
#define BLOCK_SIZE 18					//Default = 11
#define BLOCK_SIZE_SCALE_2 11				//Default = 7
#define BLOCK_SIZE_SCALE_1 21				//BLOCK_SIZE_SCALE_1 = 4*(BLOCK_SIZE_SCALE_2/2) + 1
#define BLOCK_SIZE_SCALE_0 41				//BLOCK_SIZE_SCALE_0 = 4*(BLOCK_SIZE_SCALE_1/2) + 1
...
#define SEARCH_DISTANCE 4					//Default = 3
#define MAX_SEARCH_DIST_RADIUS ((4+2+1)*SEARCH_DISTANCE)
#define AREA_NUMBER 32						//Default = 32
#define AREA_SIZE (SLICE_WIDTH/AREA_NUMBER)
#define INIT_AREA_THERSHOLD 700				//Default = 700
#define MAX_SLICE_DURATION_US 300000				//Default = 300000
...
#define NPC_SCALE_0 3						//Default = 3
#define NPC_SCALE_1 1						//Default = 1
...
const int maxAllowedSadValueScale0 = ap_uint<BITS_PER_PIXEL>(0xffff) * maxAllowedSadDistance * BLOCK_AREA_SCALE_0;
const int maxAllowedSadValueScale1 = ap_uint<BITS_PER_PIXEL>(0xffff) * maxAllowedSadDistance * BLOCK_AREA_SCALE_1;
const int maxAllowedSadValueScale2 = ap_uint<BITS_PER_PIXEL>(0xffff) * maxAllowedSadDistance * BLOCK_AREA_SCALE_2;
