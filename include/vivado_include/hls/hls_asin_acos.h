...
static volatile const double Tiny = 2.2250738585072014e-308; //0x1p-1022;
...
{
  if (-2.1491193328908206e-08 <= x && x <= 2.1491193328908206e-08) // 0x1.7137449123ef5p-26
	  return -2.2250738585072014e-308 < x && x < 2.2250738585072014e-308 // +0x1p-1022 
...
static double Tail(double x)
{
	...
	double polynomial = ((((((((((((
		...
		static const double2
			...
			HalfPi = { 1.5707963267948966, 6.123233995736766e-17 },
			p00 = { -1.5707961988153776, 1.0640719477080884e-16 };
...
static double Center_acos(double x)
{
	...
	*/
	if (-1.722546424198833e-16 <= x && x <= 1.722546424198833e-16)
		return HalfPi + Tiny;
	...
	double t0 = (((((((((((
		...
		static const double2
		  // p00 = { 0x1.921fa926d2f24p0, +0x1.b4a23d0ecbb40p-59 };
			p00 = { 1.5707956046853235, 2.958745337546587e-18 };
